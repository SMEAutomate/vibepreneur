      ...
      <Card className="flex h-full flex-col space-y-4">
        ...
        <div className="mt-auto rounded-lg bg-brand-50 p-4">
          <p className="text-xs font-semibold uppercase tracking-wider text-brand-700">
            How Vibepreneur helps
          </p>
          <p className="mt-1 text-sm text-brand-800">
            {solution.vibepreneurHook}
          </p>
        </div>
      </Card>
    </motion.div>
          ...
          {sector ? (
            <>
              <p className="text-sm font-medium text-brand-600">
                Based on your {roleLabel} experience in {sector.label}
              </p>
              <h1 className="mt-2 text-display-md">Your Fit Test Results</h1>
              <p className="mt-4 text-lg text-neutral-600">
                {sector.sectorContext}
              </p>
              <p className="mt-4 text-neutral-600">
                Here are 3 opportunities where your expertise creates real
                market value.
              </p>
            </>
          ) : (
            <>
              ...
              <p className="mt-4 text-lg text-neutral-600">
                ...
                uniquely qualified to address. Each includes a clear path to
