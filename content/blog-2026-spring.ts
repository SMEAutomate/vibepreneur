...
export const spring2026Posts: BlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Stop using cost-plus pricing. Use value-based pricing. The formula many productized-services practices use: Fee equals quantified outcome times your attribution percentage times 10 to 20 percent. If your engagement helps a client recover 500,000 dollars in revenue and you can credibly attribute 30 percent to your work, your fee anchor is between 15,000 and 30,000 dollars. Communicate the math in the proposal.",
  ...
  },
  {
    ...
    body: [
      ...
      "## The formula",
      "Fee equals quantified outcome times attribution percentage times 10 to 20 percent. A worked example: a consulting engagement helps a client recover 500,000 dollars in lost revenue over twelve months. You can credibly attribute 30 percent to your direct work. The capture rate is 15 percent. The fee is 22,500 dollars. The number is grounded in the outcome rather than in your time.",
      ...
      "When the outcome is genuinely hard to quantify (creative work, brand work, early-stage advisory), a flat fixed-fee productized offer often works better than either hourly or value pricing. For sub-10,000 dollar engagements, the diagnostic overhead can swamp the upside.",
  ...
  },
  {
    ...
    body: [
      ...
      "A productized service can succeed with a small, high-paying audience. Five clients at 30,000 dollars per engagement produces 150,000 dollars from a small audience. A vertical SaaS needs density. To reach one million dollars ARR at 200 dollars per month, you need around 400 paying accounts. Estimate the addressable audience in your niche before committing.",
  ...
  },
  {
    ...
    body: [
      ...
      "A VP of marketing who has repositioned three to five companies has a repeatable diagnostic. Productize as a three-week fixed-fee engagement with a CEO-approved positioning artifact, a headline test plan, and a pricing-page rewrite. Fee anchor: 15,000 to 30,000 dollars per sprint.",
      "## Sales leader to objection-handling clinic",
      "A VP of sales who has built objection libraries productizes a four-week clinic for AE teams. Weekly group sessions, roleplay calls, a custom objection library, a manager scorecard. Fee anchor: 25,000 to 50,000 dollars per cohort.",
      "## Operations leader to SLA tracker or workflow SaaS",
      "Operations leaders accumulate workflow pattern recognition. If the workflow is rules-based (carrier SLA scoring, inventory thresholds, compliance reporting), vertical SaaS fits. Price anchor: 500 to 2,500 dollars per month per account.",
      "## HR leader to onboarding rebuild",
      "People operations leaders see the same onboarding gaps across every growth company. Productize as an opinionated platform or an eight-week rebuild engagement. Fee anchor: 20,000 to 50,000 dollars per rebuild.",
      "## Finance leader to cap table clinic or fractional CFO",
      "Finance leaders have two productizable formats. A fixed-fee cap-table audit before fundraises, or a fractional CFO retainer for sub-Series B companies. Fee anchor: 5,000 to 15,000 dollars per clinic; 5,000 to 20,000 dollars per month fractional.",
      "## Legal counsel to fixed-fee contract package",
      "Startup lawyers accumulate document patterns. A fixed-fee package (founders' agreement, IP assignment, advisor agreement, MSA template) productizes work founders currently piece together from internet templates. Fee anchor: 1,500 to 5,000 dollars per package.",
      "## Product lead to discovery coaching",
      "Senior PMs accumulate discovery framework pattern recognition. An eight-week one-to-one coaching engagement structured around real product bets is sellable to mid-career PMs at Series B and beyond. Fee anchor: 4,000 to 10,000 dollars per program.",
      "## Customer success leader to onboarding uplift",
      "CS leaders accumulate retention pattern recognition. An eight-week audit-plus-rebuild engagement lifts 90-day retention by 8 to 15 points. Fee anchor: 25,000 to 60,000 dollars per engagement.",
      "## Program manager to PMO rescue",
      "Senior program managers accumulate stakeholder management pattern recognition. A six-week embedded engagement that triages a stalled program and hands it off is sellable to mid-market enterprises. Fee anchor: 40,000 to 80,000 dollars.",
      "## Chief of staff to EOS implementation",
      "Chiefs of staff accumulate operating-rhythm pattern recognition. A 90-day productized implementation of EOS is sellable to owner-operators below 100 employees. Fee anchor: 25,000 to 50,000 dollars.",
      "## Platform engineer to coaching for scaling teams",
      "Senior platform engineers accumulate scaling pattern recognition. A six-week coaching engagement for one platform-engineering lead through the 30-to-150 engineer transition is bookable. Fee anchor: 15,000 to 30,000 dollars.",
      "## Staff designer to design system refit",
      "Staff designers accumulate design-system pattern recognition. A four-week audit plus 60-day refit for a Series B company is sellable as a fixed-fee package. Fee anchor: 40,000 to 80,000 dollars.",
      "## Independent consultant to niching sprint",
      "Consultants who have helped peers narrow positioning accumulate a sellable framework. A two-week sprint that produces one positioning, one offer, one pricing page is sellable to other independents. Fee anchor: 3,000 to 8,000 dollars.",
      "## Pattern recognition across the 13",
      "Ten of the thirteen formats are sprints or fixed-fee engagements rather than SaaS. The three SaaS-leaning roles share a property: the underlying work is rules-based enough that software can replace meaningful judgment. Most other roles do not have this property. Fee anchors cluster between 15,000 and 50,000 dollars for sprints, the band where a department head can approve without going to the board. Vibepreneur's showcase library has a starter venture for each of the 13 roles. See [the showcase](/the-system).",
    ],
    pullquote:
      "Ten of the thirteen formats are sprints or fixed-fee engagements. The fee band where a department head can approve without going to the board is 15,000 to 50,000 dollars.",
  },
  {
    ...
    readTime: "7 min read",
    body: [
      "A common finding in solo-founder research: around 72 percent of successful indie hackers cite distribution, not product, as the deciding factor. A 30-day validation sprint costs zero dollars in software and produces the evidence needed to commit to or kill a venture before any real build.",
      "## The premise",
      ...
      "The constraint is six months of profitability. Ventures that take more than six months to reach 5,000 dollars MRR or to pre-sell 30,000 dollars in letters of intent rarely cross to sustainability.",
  ...
  },
  {
    ...
    readTime: "6 min read",
    body: [
      "Five templates cover the most common validation needs: demand signal, conversion intent, channel viability, willingness to pay, and concierge MVP. Each template has a hypothesis frame, a channel, a measurable threshold, and an explicit stop signal. All five cost zero dollars in software and produce evidence in days.",
  ...
  },
  {
    ...
    body: [
      ...
      "Paid waitlist deposit (for engagements over 5,000 dollars): a refundable 100 or 250 dollar deposit converts interest into commitment. Held; credited later.",
      "## The timing rules",
  ...
  },
  {
    ...
    body: [
      ...
      "At 200 dollars per month average revenue per account, one million dollars ARR requires around 400 paying accounts. Capturing 400 of 10,000 is a 4 percent market share. Capturing 400 of 100,000 is 0.4 percent. Both are achievable for a focused solo founder over 18 to 36 months.",
      "## The 12 industries",
      ...
      "The current state is spreadsheets plus a generic horizontal tool that does not respect the vertical workflow. The opportunity is a focused, opinionated product priced under 500 dollars per month per account that respects the vertical workflow. The distribution is founder-led outreach into the trade or industry community.",
  ...
  },
  {
    ...
    body: [
      ...
      "Cost pressure on senior roles: hiring a full-time VP of Marketing at 250,000 dollars plus benefits and equity is expensive for a Series A or B company that may need that expertise for only 12 to 18 months. A fractional CMO at 10,000 dollars per month delivers the same expertise for the period needed.",
      ...
      "Fractional CMO: growing fastest. Series A to C SaaS companies are the dominant buyer. 10 to 20 hours per week at 8,000 to 20,000 dollars per month.",
      "Fractional CFO: strong demand from pre-Series B startups. 8 to 15 hours per week at 5,000 to 15,000 dollars per month.",
      "Fractional COO: demand from owner-operated businesses with 30 to 200 employees. 15 to 25 hours per week at 8,000 to 20,000 dollars per month.",
      "Fractional CTO: common at very early-stage startups. 10 to 20 hours per week at 10,000 to 25,000 dollars per month.",
      "Specialist fractional roles (Head of Growth, People, Sales, CS): 8 to 15 hours per week at 5,000 to 15,000 dollars per month. Growing fastest as a percentage of total.",
      "## How senior operators are entering",
      "Months 1 to 3: build positioning. Define the specific buyer and the specific outcome. Months 2 to 4: find the first client, usually through warm network or a fractional marketplace. The first engagement is often slightly under-priced to build the case study. Months 4 to 8: serve the first 2 to 3 clients well, document the engagement structure, build referenceable outcomes. Months 6 to 12: raise rates. The second cohort prices 30 to 60 percent higher. By month 12, a focused fractional operator typically reaches 20,000 to 40,000 dollars per month in fee revenue.",
  ...
  },
  {
    ...
    body: [
      ...
      "At day 90 if the offer produces 5,000 to 10,000 dollars per month, you have a viable second income stream. If it produces 20,000 or more, you have a credible path to making it your primary income.",
  ...
  },
  {
    ...
    readTime: "7 min read",
    body: [
      "The 6-month rule states that a first venture should either reach approximately 5,000 dollars monthly recurring revenue or pre-sell approximately 30,000 dollars in letters of intent by month 6. Ventures that miss this benchmark rarely cross to sustainability.",
      ...
      "5,000 dollars MRR for SaaS, productized services, or memberships. This is meaningful supplementary income and it signals customers are paying real money for the offer.",
      "30,000 dollars in letters of intent for higher-priced, lower-volume engagements (fractional, productized consulting, enterprise software). A letter of intent is meaningful even if the engagement has not started, because it represents a buyer who has committed budget.",
      ...
      "Opportunity cost: 18 months of unpaid solo founder work is approximately 150,000 to 300,000 dollars of foregone income. Motivation decay: months 12 to 18 are a known-difficult stretch where motivation craters. Distribution rust: a venture that has not had paying customers by month 12 has not stress-tested its distribution motion.",
      "## How to architect for the 6-month rule",
      "Start with a higher-priced offer. A productized service at 5,000 dollars per engagement reaches 5,000 dollars MRR with 1 customer per month. A SaaS at 50 dollars per month requires 100 paying customers. The first is easier to architect into 6 months.",
      ...
      "If your venture has reached 3,000 dollars MRR at month 6 (close but not at the threshold), the right move is sometimes to start a second venture rather than doubling down on the first. The first venture has revealed your distribution muscle, your delivery muscle, your offer-design muscle. Two ventures at 3,000 dollars MRR each is structurally healthier than one at 4,000.",
    ...
    pullquote:
      "Either reach 5,000 dollars MRR by month 6 or pre-sell 30,000 dollars in letters of intent. Ventures that miss both rarely cross to sustainability.",
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "A senior operations leader at a mid-sized logistics company built an internal tool for tracking carrier SLA performance. The tool surfaced about 50,000 dollars per quarter in money the company was owed under SLA contracts. After two years of internal use, the operator realised the same problem exists at most mid-market shippers.",
      "Days 1 to 3: drafted a one-page offer description. Built a list of 25 ops leaders. Days 4 to 7: sent 20 personal DMs. 8 replied. 5 booked discovery calls. Days 8 to 10: ran the 5 discovery calls. Two asked specifically when the tool would be available. Days 11 to 14: offered a 5,000 dollar pre-sale for first access. Two signed letters of intent. One committed a deposit.",
      "Result: 10,000 dollars in signed letters of intent in 14 days for a product that was an internal tool. The key was framing the offer as access, not features.",
      ...
      "Days 1 to 2: wrote a one-page offer: three-week positioning sprint, 25,000 dollars, includes CEO-approved positioning artifact, headline test plan, and pricing-page rewrite. Days 3 to 5: emailed 15 founders with one line of context plus the offer page. Days 6 to 10: ran 7 calls. 3 founders were qualified and interested. Days 11 to 14: closed 2 engagements at the named price.",
      "Result: 50,000 dollars in signed engagements within 14 days, both at the productized price (which was 20 percent higher than the consultant's previous bespoke rate). The fixed scope reduces objection volume; the named price removes negotiation drift.",
      ...
      "Days 1 to 3: wrote the offer. Four-week design system audit and 60-day refit plan, 40,000 dollars. Days 4 to 7: sent 12 LinkedIn DMs to VPs of Engineering and Heads of Design. Referenced a specific recent product launch in each message. Days 8 to 11: had 4 substantive conversations. Days 12 to 14: closed 1 audit at 40,000 dollars.",
      "Result: one audit engagement at 40,000 dollars closed in 14 days. High-priced productised audits often close on the strength of one credible specialist conversation.",
  ...
  },
  {
    ...
    body: [
      ...
      "More sophisticated buyers: niche B2B buyers are usually senior practitioners. A founder posting we just hit 5,000 dollars MRR reads to a consumer audience as exciting and to a senior B2B buyer as worryingly early. The signal you intend is not the signal the audience receives.",
  ...
  },
  {
    ...
    body: [
      ...
      "Response: return to the cost of inaction. If the buyer originally named 500,000 dollars of avoidable cost over 12 months, ask what the cost of waiting 6 months is. The math is usually 250,000 dollars of additional avoidable cost.",
