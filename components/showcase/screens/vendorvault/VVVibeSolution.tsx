...
export function VVVibeSolution() {
  return (
    <AppShell
      activeNav="Solutions"
      title="Solution Builder"
      subtitle="Structuring: VendorVault"
      actions={
        <>
        ...
        <div className="space-y-5">
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div>
                ...
                <div className="mt-1 rounded-lg border border-neutral-200 bg-neutral-50 px-4 py-2.5 text-sm text-neutral-800">
                  Stop paying for tools you forgot about. Every vendor,
                  contract, and renewal in one place.
                </div>
              </div>
              <div>
                <label className="text-[10px] font-medium uppercase tracking-wider text-neutral-400">
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className="mt-4 space-y-2">
              {[
                "Vendor directory with spend tracking and owner assignment",
                "Contract renewal calendar with auto-renewal alerts",
                "Duplicate vendor and overlapping service detection",
                "Spend analytics with category breakdown and YoY trends",
                "Approval workflows for new vendor onboarding",
              ].map((f, i) => (
                <div
                  key={f}
        ...
        <div className="space-y-5">
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className="mt-4 space-y-3">
              {[
                {
                  outcome: "Eliminate duplicate vendor spend across teams",
                  metric: "$180K saved",
                },
                {
                  outcome: "Never miss a contract renewal deadline again",
                  metric: "Zero lapses",
                },
                {
                  outcome: "Reduce vendor onboarding time from weeks to days",
                  metric: "5x faster",
                },
                {
                  outcome:
                    "Full visibility into total vendor spend by category",
                  metric: "100% coverage",
                },
              ].map((o) => (
                <div
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
              {[
                { tier: "Starter", price: "$39/mo", desc: "Up to 50 vendors" },
                { tier: "Growth", price: "$99/mo", desc: "Up to 200 vendors" },
                { tier: "Scale", price: "$249/mo", desc: "Unlimited vendors" },
              ].map((t) => (
                <div
                  key={t.tier}
                ...
                >
                  ...
                  <p className="mt-1 text-[10px] text-neutral-400">{t.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-brand-100 bg-brand-50/30 p-6">
            ...
            <div className="mt-3 flex items-end gap-2">
              <span className="text-2xl font-bold text-brand-700">70%</span>
            </div>
            <p className="mt-2 text-xs text-brand-600">
              Add integration documentation and competitive analysis to reach
              90%.
            </p>
          </div>
        </div>
