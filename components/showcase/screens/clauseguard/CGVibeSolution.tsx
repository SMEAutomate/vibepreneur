...
export function CGVibeSolution() {
  return (
    <AppShell
      activeNav="Solutions"
      title="Solution Builder"
      subtitle="Structuring: ClauseGuard"
      actions={
        <>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div>
                ...
                <div className="mt-1 rounded-lg border border-neutral-200 bg-neutral-50 px-4 py-2.5 text-sm text-neutral-800">
                  Review contracts in minutes, not days. AI catches what tired
                  eyes miss.
                </div>
              </div>
              <div>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className="mt-4 space-y-2">
              {[
                ...
                "Compliance rule matching across regulatory frameworks",
                "Template library with pre-approved language",
                "Audit trail with version history and approvals",
              ].map((f, i) => (
                <div
                  key={f}
        ...
        <div className="space-y-5">
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className="mt-4 space-y-3">
              {[
                {
                  outcome: "Review contracts in minutes instead of hours",
                  metric: "90% faster",
                },
                {
                  outcome: "Catch every high-risk clause before signing",
                  metric: "Zero missed",
                },
                {
                  outcome: "Reduce reliance on outside counsel",
                  metric: "40% less spend",
                },
                {
                  outcome: "Full audit trail for every contract decision",
                  metric: "100% tracked",
                },
              ].map((o) => (
                <div
              ...
              {[
                {
                  tier: "Starter",
                  price: "$149/mo",
                  for: "Up to 50 contracts/mo",
                },
                {
                  tier: "Professional",
                  price: "$349/mo",
                  for: "Up to 200 contracts/mo",
                },
                {
                  tier: "Enterprise",
                  price: "$799/mo",
                ...
                <div
                  key={t.tier}
                  className={`rounded-xl border p-4 text-center ${t.tier === "Professional" ? "border-brand-200 bg-brand-50/30" : "border-neutral-200"}`}
                >
          ...
          <div className="rounded-2xl border border-brand-100 bg-brand-50/30 p-6">
            ...
            <p className="mt-2 text-xs text-brand-600">
              Add integration documentation and compliance certifications to
              reach 90%.
            </p>
          </div>
        </div>
