...
export function WhatYouOwn() {
  const { whatYouOwn } = siteCopy;

  return (
    <Section>
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-display-sm">{whatYouOwn.headline}</h2>
        <p className="mt-4 text-lg text-neutral-600">{whatYouOwn.body}</p>
      </div>

      <div className="mx-auto mt-12 grid max-w-4xl gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {whatYouOwn.items.map((item, i) => (
          <motion.div
            key={item.title}
